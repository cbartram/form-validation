...
var AdvancedRule = function (_AbstractRule) {
    ...
    function AdvancedRule(name) {
        ...
        var shouldBail = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : false;
    ...
    _createClass(AdvancedRule, [{
        ...
        value: function addReason(name, field, value) {
            var why = _get(AdvancedRule.prototype.__proto__ || Object.getPrototypeOf(AdvancedRule.prototype), 'getWhy', this).call(this);
            why.push(field + _ErrorCode2.default.codes()[name.toUpperCase()] + value);
            _get(AdvancedRule.prototype.__proto__ || Object.getPrototypeOf(AdvancedRule.prototype), 'setWhy', this).call(this, why);
        }
