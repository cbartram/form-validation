...
var AdvancedRule = function (_AbstractRule) {
  ...
  function AdvancedRule(name) {
    ...
    var _this = _possibleConstructorReturn(this, (AdvancedRule.__proto__ || Object.getPrototypeOf(AdvancedRule)).call(this, name, req));

    _this.activationFunction = activationFunction;
    _this.name = name;
    _this.req = req;
    _this.value = value;
    _this.key = _get(AdvancedRule.prototype.__proto__ || Object.getPrototypeOf(AdvancedRule.prototype), 'getKey', _this).call(_this);
    return _this;
  }
  ...
  _createClass(AdvancedRule, [{
    ...
    value: function isRequired() {
      return _get(AdvancedRule.prototype.__proto__ || Object.getPrototypeOf(AdvancedRule.prototype), 'isRequired', this).call(this);
    }
    ...
    value: function setReq(req) {
      _get(AdvancedRule.prototype.__proto__ || Object.getPrototypeOf(AdvancedRule.prototype), 'setReq', this).call(this, req);
    }
    ...
    value: function addReason(key, field) {
      ...
      error.setWhy(field + _ErrorCode2.default.codes()[this.name.toUpperCase()] + this.value);
    ...
    value: function getReq() {
      return _get(AdvancedRule.prototype.__proto__ || Object.getPrototypeOf(AdvancedRule.prototype), 'getReq', this).call(this);
    }
    ...
    value: function getKey() {
      return _get(AdvancedRule.prototype.__proto__ || Object.getPrototypeOf(AdvancedRule.prototype), 'getKey', this).call(this);
    }
